...
bigint::bigint (long that): long_value (that) { //constructor (this is where long_value field is created)
...
bigint operator+ (const bigint& left, const bigint& right) { //unfinished
...
bigint operator+ (const bigint& right) { //unfinished
...
long bigint::to_long() const { //might be finished
...
bool abs_less (const long& left, const long& right) { //unfinished
   return left < right;
}
...
void multiply_by_2 (bigint::unumber& unumber_value) {  //unfinished
   unumber_value *= 2;
}

void divide_by_2 (bigint::unumber& unumber_value) { //unfinished
   unumber_value /= 2;
}


bigint::quot_rem divide (const bigint& left, const bigint& right) { //unfinished
...
bigint operator/ (const bigint& left, const bigint& right) {//might be finished
...
bool operator== (const bigint& left, const bigint& right) { //unfinished
   return left.long_value == right.long_value;
}
...
bigint pow (const bigint& base, const bigint& exponent) { //might be finished
